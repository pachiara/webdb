...
class InstancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instance" do
    assert_difference('Instance.count') do
      post instances_url, params: { instance: { check: @instance.check, istance: @instance.istance, note: @instance.note, port: @instance.port, server_id: @instance.server_id } }
    end
  ...
  test "should update instance" do
    patch instance_url(@instance), params: { instance: { check: @instance.check, istance: @instance.istance, note: @instance.note, port: @instance.port, server_id: @instance.server_id } }
