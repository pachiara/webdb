...
class OperatingSystemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operating_system" do
    assert_difference('OperatingSystem.count') do
      post operating_systems_url, params: { operating_system: { code: @operating_system.code, description: @operating_system.description } }
    end
  ...
  test "should update operating_system" do
    patch operating_system_url(@operating_system), params: { operating_system: { code: @operating_system.code, description: @operating_system.description } }
