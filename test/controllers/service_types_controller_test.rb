...
class ServiceTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_type" do
    assert_difference('ServiceType.count') do
      post service_types_url, params: { service_type: { code: @service_type.code, description: @service_type.description } }
    end
  ...
  test "should update service_type" do
    patch service_type_url(@service_type), params: { service_type: { code: @service_type.code, description: @service_type.description } }
